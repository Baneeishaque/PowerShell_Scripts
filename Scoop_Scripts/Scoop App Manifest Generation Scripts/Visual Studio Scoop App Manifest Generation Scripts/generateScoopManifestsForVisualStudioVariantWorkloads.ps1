function Get-ExecutableHash($url)
{
...
$fileHash = Get-ExecutableHash -url 'https://aka.ms/vs/17/release/vs_enterprise.exe'
...
$fileHash = Get-ExecutableHash -url 'https://aka.ms/vs/17/pre/vs_enterprise.exe'
